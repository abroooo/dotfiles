    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>ct', ':ClangSwitchSourceHeader<CR>', '[C]ode [T]oggle Header/Source')
...
local function test()
  print 'helloooo'
  os.execute '~/.config/scripts/daily'
  vim.cmd 'ObsidianToday'
  -- vim.api.nvim_exec('edit ' .. '/tmp/as', false)
  -- require('obsidian').get_client().today()
  -- require('obsidian').get_client().today()
  -- vim.keymap.set("n", "<leader>wf","<CMD>lua require('telescope').extensions.git_worktree.git_worktrees()<CR>", {})
end
...
vim.keymap.set('n', '<leader>oc', ':lua ShowCheatsheet()<CR>', { desc = '[O]bsidian [c]heatsheet', silent = true, noremap = true })
